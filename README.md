...
Un petit générateur de bruit blanc.
Le bruit blanc peut être généré sur une sortie audio ou dans un fichier wav.

Il s'agit de ma toute 1ere application JUCE.

Le code est un sacré bordel, mais j'ai énormément appris sur l'utilisation de JUCE.
